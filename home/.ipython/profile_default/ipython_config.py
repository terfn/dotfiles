...
# c.InteractiveShell.banner1 = 'Python 3.5.2 |Continuum Analytics, Inc.| (default, Jul  2 2016, 17:52:12) \nType "copyright", "credits" or "license" for more information.\n\nIPython 5.0.0 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
...
# The name of a Pygments style to use for syntax highlighting:  vim, borland,
# trac, colorful, paraiso-dark, manni, paraiso-light, friendly, rrt, murphy,
# native, tango, fruity, emacs, perldoc, algol, pastie, lovelace, algol_nu,
# xcode, autumn, default, bw, vs, monokai, igor
